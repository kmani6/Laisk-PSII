function dydt = LaiskODEsNew (t,y,k,knames,Ynames) 
...
dydt(YoPoAo) = -k(jd)*y(YoPoAo)+k(oqd)*y(YoPoAoBoo)+k(rqd)*y(YoPoAoBrr)-(k(oqr)*y(PQ)+r(rqr)*y(PQH2))*y(YoPoAo); 
dydt(YoPoAoBoo) = -k(jd)*y(YoPoAoBoo)-r(oqd)*y(YoPoAoBoo)+r(oqr)*y(PQ)*y(YoPoAo); 
dydt(YoPrAo) = k(jd)*y(YoPoAo)-k(jd)*y(YoPrAoBrr)+r(oqd)*y(YoPrAoBoo)-(k(oqr)*y(PQ)*r(rqr)*y(PQH2))*y(YoPrAo)-k(n2)*k(kp)/(1+k(kp)+k(kr))*y(YoPrAo);
dydt(YoPoAr) = -k(jd)*y(YoPoAr) +k(n2) + k(kp)/(1+k(kp)+k(kn)+k(kr))*y(YoPrAo)+k(rqd)*y(YoPoArBrr)+r(oqd)*y(YoPoArBoo)-(k(oqr)*y(PQ)+r(rqr)*y(PQH2))*y(YoPoAr);
dydt(YoPrAoBoo) = -k(jd)*y(YoPrAoBoo) + k(jd)*y(YoPoAoBoo) - n2*(kp/(1+k(kp)+k(kn)+k(kr)))*y(YoPrAoBoo)-k(oqd)*y(YoPrAoBoo)+k(oqr)*y(PQ)*y(YoPrAo);		
dydt(YoPoArBoo) = -k(jd)*y(YoPoArBoo)+n2*(k(kp)/(1+k(kp)+k(kn)+k(kr)))*y(YoPrAoBoo)+k(oqr)*y(PQ)*y(YoPoAr)-k(oqd)*y(YoPoArBoo)-k(b1d)*y(YoPoArBoo)+k(b1r)*y(YoPoAoBro);		
...
dydt(YrPrAoBoo) = k(jd)*y(YoPrAoBoo)-n2*k(kp)/(1+k(kp)+k(kn))*y(YrPrAoBoo)+k(oqr)*y(PQ)*y(YrPrAo)-k(oqd)*y(YrPrAoBoo); 	
